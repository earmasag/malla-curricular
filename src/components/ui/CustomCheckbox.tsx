        ...
        <label className="flex items-center gap-3 cursor-pointer group w-full text-left">
            <div className="relative flex items-center justify-center shrink-0">
                <input
                    ...
                    className="peer appearance-none w-5 h-5 border-2 border-gray-300 rounded bg-white checked:bg-theme-500 checked:border-theme-500 focus:outline-none focus:ring-4 focus:ring-theme-50 transition-all cursor-pointer"
                />
