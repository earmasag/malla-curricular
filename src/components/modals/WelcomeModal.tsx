            ...
            <div className="bg-white rounded-3xl p-8 md:p-10 w-full max-w-lg shadow-2xl relative animate-in zoom-in-95 duration-300">
                ...
                <div className="flex flex-col gap-4">
                    <button
                        ...
                        className="flex flex-col items-center justify-center p-5 bg-white border-2 border-gray-200 rounded-2xl hover:border-theme-500 hover:bg-theme-50 transition-all group cursor-pointer"
                    >
                        <span className="text-xl font-bold text-gray-700 group-hover:text-theme-700">Plan Antiguo</span>
                        <span className="text-sm text-gray-500 group-hover:text-theme-500 mt-1">Septiembre 2023 - TERM 202415</span>
                    </button>

                    <button
                        onClick={() => handleSelectPlan("202715")}
                        className="flex flex-col items-center justify-center p-5 bg-white border-2 border-gray-200 rounded-2xl hover:border-theme-500 hover:bg-theme-50 transition-all group cursor-pointer relative overflow-hidden"
                    >
                        <div className="absolute top-0 right-0 bg-theme-500 text-white text-xs font-bold px-3 py-1 rounded-bl-lg">
                            NUEVO
                        </div>
                        <span className="text-xl font-bold text-gray-700 group-hover:text-theme-700">Plan Modificado</span>
                        <span className="text-sm text-gray-500 group-hover:text-theme-500 mt-1">Septiembre 2026 - TERM 202715</span>
                    </button>
                </div>
