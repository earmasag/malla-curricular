            ...
            <div className="fixed top-6 left-1/2 -translate-x-1/2 z-40 flex items-center gap-2">
                ...
                {activePlanId === "202415" && (
                    <button
                        ...
                        className="group flex items-center justify-center w-11 h-11 bg-linear-to-br from-theme- to-theme- hover:from-theme- hover:to-theme- text-white rounded-full shadow-lg shadow-theme-/30 border border-theme- transition-all duration-300 animate-in slide-in-from-left-4 fade-in"
